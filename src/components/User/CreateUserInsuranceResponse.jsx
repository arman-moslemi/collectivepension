    ...
    return (
        <div className="w-full flex flex-col items-center rounded-[6px] bg-white px-[32px] pt-[40px] pb-[15px]">
            ...
            <div className="w-full">
                ...
                pageButton={<div className="flex"><div className="ml-3 w-[186px]"><MainButton label={'مشاهده سوابق'}/></div>
                
                {/* اگه درخواست تایید نشد و رد شده بود بتونه اعتراض بزنه :

                <div className="w-[186px]"><MainButton label={'ثبت اعتراض'} red={true}/></div> */}
                </div>} />
            </div>
             :
             <div className="w-full">

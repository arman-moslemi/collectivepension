      ...
      if (data?.status == 200) {
        ...
        data.data?.data?.map((item, index) => {
          prot.push({
            ...
            item1:index+1,
            item2: item.year || 0,
            item3: item.recordType || "",
            item4: item.branchName || '',
            item5: item.workplaceNumber || "",
            item6: item.workplaceName || '',
            item7: item.month1 || 0,
            item8: item.month2 || 0,
            item9: item.month3 || 0,
            item10: item.month4 || 0,
            item11: item.month5 || 0,
            item12: item.month6 || 0,
            item13: item.month7 || 0,
            item14: item.month8 || 0,
            item15: item.month9 || 0,
            item16: item.month10 || 0,
            item17: item.month11 || 0,
            item18: item.month12 || 0,

...
import {MainModal,MainButton,AcceptedRecordModal} from "..";
...
const RecordProtestDetail = () =>{
    ...
    const ModalFunction = () => {setShowModal(false);
    ...
    const tableData = [
        {
          ...
          expertStatus: 'رد شده',
          rows: [
            //عدد اعلام شده توسط کاربر برای تعداد روز و بازه باید قرمز رنگ باشه
            {
              type: <>
    ...
    return (
       ...
       <div className="pt-[17px]">
        ...
        جزئیات اعتراض ثبت شده
         ...
         <div className="min-w-[80%] w-[80%] mx-auto mt-6 border-[1px] border-borderGray rounded-[10px] overflow-hidden">
         <table className="min-w-[100%] table-auto text-right">
            <thead>
...
>
    ...
    {group.expertStatus}
              ...
              <button onClick={()=>setShowModal(true)} className="w-[38px] h-[38px] mx-auto rounded-full bg-backBlue flex justify-center items-center" >
          <DetailTableIcon />
        </button>
              </td>
            </>
...
<p className="text-right">با توجه به مدارک بارگزاری شده در پیوست، بازه زمانی بیمه پردازی بنده اشتباه ثبت شده است لطفا مجدد بررسی بفرمایید.</p>
            ...
            <div className='w-fit h-[28px] bg-tableGray rounded-[50px] flex items-center pl-1 pr-[11px] hover:cursor-pointer'>
          ...
          modalButton={
            <div className="w-full flex justify-center">
              <div className="w-[140px]">
                <MainButton  onClickFunction={handleAccept} label={"تایید"} />
                
              </div>
              <div className="w-[140px] mr-2">
                <MainButton onClickFunction={ModalFunction} red={true} label={"عدم تایید"} />

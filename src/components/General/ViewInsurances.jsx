...
const ViewInsurances = ({ isEnding, data }) => {
    return (
        isEnding ?
            <div className="w-full px-[120px] h800:px-[15px] mb-8 grid grid-cols-6 md:grid-cols-3 gap-4">
            ...
            :
            <div className="w-full px-[120px] h800:px-[15px] mb-9 grid md:grid-cols-3 grid-cols-6  gap-4">

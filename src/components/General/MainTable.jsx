            ...
            :
             <table className={`w-full`}>
                <tr className="bg-tableGray h-[66px] ">
                    ...
                    {titleRow[1]? <td className={`font-IRANYekanBold text-[12px] ${record1 ? 'w-[180px]' : 'w-auto'} ${lastColIndex === 1 ? 'text-center' : 'text-right'} ${center3? 'px-1':cen4? 'px-5':cen5? 'w-28 pr-14 pl-28': 'px-2'}`}>{titleRow[1]}</td> : null}
                    {titleRow[2]? <td className={`font-IRANYekanBold text-[12px] ${record2 ? 'w-[180px]' : 'w-auto'} ${cen5?'w-[250px]': cen6?'w-[200px]':'w-full'} ${center2 ? 'text-center' : (lastColIndex === 2 ? 'text-center' : 'text-right')} ${center3 ? 'px-1' : cen4? 'px-5': 'px-2'}`}>{titleRow[2]}</td> : null}
                    {titleRow[3]? <td className={`font-IRANYekanBold text-[12px] ${record3 ? 'w-[180px]' : 'w-auto'} ${lastColIndex === 3 ? 'text-center' : 'text-right'} ${center3? 'px-1':cen4? 'px-5': 'px-2'}`}>{titleRow[3]}</td> : null}
                    {titleRow[4]? <td className={`font-IRANYekanBold text-[12px] ${record4 ? 'w-[180px]' : 'w-auto'} ${lastColIndex === 4 ? 'text-center' : 'text-right'} ${center3? 'px-1':'px-2'}`}>{titleRow[4]}</td> : null}
                    {titleRow[5]? <td className={`font-IRANYekanBold text-[12px] ${record5 ? 'w-[180px]' : 'w-auto'} ${lastColIndex === 5 ? 'text-center' : 'text-right'} ${center1 ? 'text-center' : (lastColIndex === 5 ? 'text-center' : 'text-right')} ${center3 ? 'px-1' : 'px-2'}`}>{titleRow[5]}</td> : null}
                    {titleRow[6]? <td className={`font-IRANYekanBold text-[12px] ${record6 ? 'w-[180px]' : 'w-auto'} ${lastColIndex === 6 ? 'text-center' : 'text-right'} ${center1 ? 'text-center' : (lastColIndex === 6 ? 'text-center' : 'text-right')} ${center3 ? 'px-1' : 'px-2'}`}>{titleRow[6]}</td> : null}
                    {titleRow[7]? <td className={`font-IRANYekanBold text-[12px] ${lastColIndex === 7 ? 'text-center' : 'text-right'} ${center3? 'px-1':'px-2'}`}>{titleRow[7]}</td> : null}
                    {titleRow[8]? <td className={`font-IRANYekanBold text-[12px] ${lastColIndex === 8 ? 'text-center' : 'text-right'} ${center3? 'px-1':'px-2'}`}>{titleRow[8]}</td> : null}
                    {titleRow[9]? <td className={`font-IRANYekanBold text-[12px] ${lastColIndex === 9 ? 'text-center' : 'text-right'} ${center3? 'px-1':'px-2'} pl-4 `}>{titleRow[9]}</td> : null}
                </tr>
                ...
                {list.map((item, index) => (
                    <tr key={index} className="h-[58px] border-t-[1px] border-dashed border-borderGray">
                        ...
                        {item.item3 ? <td className={`font-IRANYekanMedium text-[12px] ${record2 ? 'w-[180px]' : 'w-auto'} ${cen5?'w-[250px]': cen6?'w-[200px]':'w-full'} ${lastColIndex === 2 ? 'text-center' : 'text-right'} ${center3? 'px-1':cen4? 'px-5': 'px-2'}`}>{item.item3}</td> : null}

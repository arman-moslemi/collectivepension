            ...
            :
             <table className={`w-full`}>
                <tr className="bg-tableGray h-[66px] ">
                    ...
                    {titleRow[2]? <td className={`font-IRANYekanBold text-[12px] ${record2 ? 'w-[180px]' : 'w-auto'}  ${center2 ? 'text-center' : (lastColIndex === 2 ? 'text-center' : 'text-right')} ${center3 ? 'px-1' : cen4? 'px-5': 'px-2'}`}>{titleRow[2]}</td> : null}

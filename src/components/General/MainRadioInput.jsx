...
const MainRadioInput = ({title,text1,text2,text3,radioName,smallBlack,
    ...
    return (
            ...
            <div className="flex flex-col justify-start items-start">
                ...
                <input className="w-[18px] h-[18px]" checked={value1==selectedValue}   name={radioName} onChange={() => onChange(value1)} type="radio" />
                ...
                <input className="w-[18px] h-[18px]" checked={value2==selectedValue}   name={radioName}onChange={() => onChange(value2)} type="radio" />
                ...
                <input className="w-[18px] h-[18px]" checked={value3==selectedValue}  name={radioName} onChange={() => onChange(value3)} type="radio" />
                <label className="font-IRANYekanBold text-[16px] text-mainBlue mr-2">{text3}</label>
                {input? <div className="mr-2 w-[400px]"><MainInput onChange={(e) => onChangeInput(e.target.value)}/></div> : null}
                </div>
                : null }

    ...
    return (
        ...
        >
          {listItems.map((item) => (
            ...
            :
            longText?
              <textarea className="border-[1px] p-2 w-full mt-2 border-borderGray rounded-[6px] focus-visible:outline-none font-IRANYekanMedium text-[16px]" value={value} rows={5} name="" id=""></textarea>
            :
            search?

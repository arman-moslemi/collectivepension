          ...
          <button onClick={() => setSidebarOpen(true)}>
            ...
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h16" />
                ...
                <div className="w-[18%] min-w-[270px] bg-white h-auto relative block b1115:hidden b1115:w-[0%]">                        <div className="absolute z-10 top-12"><SidebarMainIcon /></div>
  ...
  <div className="absolute inset-0 z-50 hidden  b1115:flex">
    <div className="w-[250px] bg-white b1115:bg-mainBlue p-4 h-full overflow-y-auto shadow-lg">
      ...
      {[ 
        ...
        { to: "/user/updateUserBaseInfoHimself", icon: PensionRequestIcon, label: "درخواست مستمری جمع", admin: true },

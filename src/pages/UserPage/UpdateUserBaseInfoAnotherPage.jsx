import { UpdateUserBaseInfoAnother, MainTopAll } from "../../components";
import PensionRequestIcon from "../../assets/icon/user/PensionRequestIcon";


const UpdateUserBaseInfoAnotherPage = () => {
    return (
        <div className="pr-[20px] pl-[60px] py-[55px]">
            ...
            <div className="w-full"><UpdateUserBaseInfoAnother/></div>   
        </div>
    );
  };
  
  export default UpdateUserBaseInfoAnotherPage;
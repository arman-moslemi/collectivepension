...
const ExistingRecordsPage = () => {
    ...
    const [repete, setRepeate] = useState([]);
    const [objYear, setObjYear] = useState({
        InsuranceId: 0,
        InsuranceIdNumber: "",
        Branch: "",
        Workplace: "",
    ...
    return (
        <div className="pr-[20px] pl-[60px] py-[55px] b1115:pl-[20px] md:py-[25px]">
            ...
            <div className="w-full mb-[20px]"><ExistingRecords setObjYear={setObjYear} setSelectedYearBox={setSelectedYearBox}
                selectedYearBox={selectedYearBox} objYear={objYear} repete={repete} /></div>
            {selectedYearBox ? <div className="w-full mb-[20px]"><ExistingRecordsMainDetails selectedYearBox={selectedYearBox} setSelectedMonthBox={setSelectedMonthBox}
                objYear={objYear} setObjMonth={setObjMonth}setObjYear={setObjYear} /></div> : null}
            ...
            <div className="w-full "><ExistingRecordsRepeated setRepeate={setRepeate} /></div>
